...
#print(dataKelompok) #Data Kel
#print(sum(XiFi)) #Total XiFi
#print(sum(Fi)) #Total Fi
...
#Jangkauan
# print(f"Jangkauan = {max(dataKelompok[1])-min(dataKelompok[0])}")
R = (max(dataKelompok[1])-min(dataKelompok[0]))
#Mean
# print(f"Mean = {Mean}")
#Simpangan Rata Rata
# print(f"Sr = {jmlXi_X_abs/sum(Fi)}")
